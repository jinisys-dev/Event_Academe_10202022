...
namespace Jinisys.Hotel.Reports.Presentation.Report_Documents.Event_Management {
    ...
    public class AlpaContract : ReportClass {
    ...
    public class CachedAlpaContract : Component, ICachedReport {
        
        public CachedAlpaContract() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AlpaContract rpt = new AlpaContract();
            rpt.Site = this.Site;
            return rpt;
        }
