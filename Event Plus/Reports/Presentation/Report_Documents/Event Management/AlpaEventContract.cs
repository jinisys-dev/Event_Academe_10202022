...
namespace Jinisys.Hotel.Reports.Presentation.Report_Documents.Event_Management {
    ...
    public class AlpaEventContract : ReportClass {
        
        public AlpaEventContract() {
        }
        
        public override string ResourceName {
            get {
                return "AlpaEventContract.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAlpaEventContract : Component, ICachedReport {
        
        public CachedAlpaEventContract() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AlpaEventContract rpt = new AlpaEventContract();
            rpt.Site = this.Site;
            return rpt;
        }
